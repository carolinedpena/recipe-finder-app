...
} //not returned so put in curly braces
...
acc: 18/ acc + cur.length = 25 > limit/ newTitla = ['Pasta', 'with', 'tomato']
*/
export const limitRecipeTitle = (title, limit = 17) => {
    const newTitle = []; //adding to an array is NOT mutation. Can declare as a const
